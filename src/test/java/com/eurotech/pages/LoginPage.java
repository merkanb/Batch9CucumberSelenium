...
public class LoginPage extends BasePage{
    ...
    @FindBy(xpath = "//*[contains(text(),'valid')]")            // check TO DO
    ...
    if (expectedErrorMessage.contains("@")){
        actualMessage=usernameInput.getAttribute("validationMessage");  // validationMessage is attribute of tooltip
    } else if (expectedErrorMessage.contains("character")) {
        actualMessage=passwordInput.getAttribute("validationMessage"); // need to add blank username and correct pss. option
    }else {
